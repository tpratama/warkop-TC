...
<body>
        ...
        <div class="navbar-inner">
            <div class="container">
                ...
                <div class="nav-collapse collapse pull-right">
                    <ul class="nav">
                        <li class="active"><a href="about-us.php">Trending Thread</a></li>
    ...
    <section id="about-us" class="container main">
		...
		$query = mysql_query("SELECT ID_THREAD, DATE_THREAD, user.LAST_UPDATE, NAMA_USER, TITLE, STICKY_FLAG from thread,user where thread.ID_USER=user.ID_USER");
		while ($row = mysql_fetch_array($query)) 
		{
			echo "<a href='#'><h1 class='left'>".$row['TITLE']."</h1></a><br>";
			echo "<h3 class='left'>by: ".$row['NAMA_USER'].", ".$row['DATE_THREAD']."</h3><br>";
		}
		?>
